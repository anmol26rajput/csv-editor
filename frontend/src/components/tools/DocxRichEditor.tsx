    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                ...
                class: 'prose prose-sm sm:prose-base focus:outline-none max-w-none bg-white shadow-lg border border-ink-200 mx-auto my-8 relative',
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center p-12 bg-white rounded-2xl border shadow-sm min-h-[600px]">
                ...
                <p className="text-ink-600 font-medium">Extracting text and images...</p>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="sticky top-0 z-20 flex flex-wrap items-center gap-2 p-3 bg-white border-b shadow-sm">
                ...
                <div className="flex items-center gap-1 border-r pr-2">
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors", editor?.isActive('bold') && 'bg-brand-100 text-brand-700')}
                        title="Bold"
                    >
                    ...
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors", editor?.isActive('italic') && 'bg-brand-100 text-brand-700')}
                        title="Italic"
                    >
                    ...
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors", editor?.isActive('strike') && 'bg-brand-100 text-brand-700')}
                        title="Strikethrough"
                    >
                ...
                <div className="flex items-center gap-1 border-r pr-2">
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors font-bold", editor?.isActive('heading', { level: 1 }) && 'bg-brand-100 text-brand-700')}
                        title="Heading 1"
                    >
                        H1
                    </button>
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors font-bold", editor?.isActive('heading', { level: 2 }) && 'bg-brand-100 text-brand-700')}
                        title="Heading 2"
                    >
                        H2
                    </button>
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors font-bold", editor?.isActive('heading', { level: 3 }) && 'bg-brand-100 text-brand-700')}
                        title="Heading 3"
                    >
                        H3
                    </button>
                ...
                <div className="flex items-center gap-1 border-r pr-2">
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors", editor?.isActive('bulletList') && 'bg-brand-100 text-brand-700')}
                        title="Bullet List"
                    >
                    ...
                    <button
                        ...
                        className={cn("p-2 rounded hover:bg-ink-100 transition-colors", editor?.isActive('orderedList') && 'bg-brand-100 text-brand-700')}
                        title="Numbered List"
                    >
                ...
                <div className="flex items-center gap-1 border-r pr-2 mr-2">
                    <button
                        onClick={addImage}
                        className="p-2 rounded hover:bg-ink-100 transition-colors text-ink-600 hover:text-brand-600"
                        title="Insert Image"
                    >
            ...
            {editor && (
                ...
                >
                    <div className="flex items-center gap-1 p-1 bg-white border border-ink-200 shadow-xl rounded-lg">
                        <button
                            onClick={() => resizeImage(1.2)}
                            className="p-1.5 text-xs font-medium text-ink-600 hover:bg-ink-100 rounded"
                            title="Increase Size"
                        >
                            +20%
                        </button>
                        ...
                        <div className="w-px h-4 bg-ink-300 mx-1" />
                        <button
            ...
            <div className="flex-1 bg-ink-100 overflow-y-auto w-full flex justify-center pb-12">
